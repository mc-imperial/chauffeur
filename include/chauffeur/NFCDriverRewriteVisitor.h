...
#ifndef NFCDRIVERREWRITEVISITOR_H
#define NFCDRIVERREWRITEVISITOR_H
...
namespace chauffeur
{
  using namespace clang;
	...
	class NFCDriverRewriteVisitor : public AbstractDriverRewriteVisitor
	{
	protected:
	...
	public:
	  explicit NFCDriverRewriteVisitor(CompilerInstance *CI, bool doInline)
      : AbstractDriverRewriteVisitor(CI, doInline)
    {

    }

    virtual ~NFCDriverRewriteVisitor() {}
	};
}

#endif // NFCDRIVERREWRITEVISITOR_H

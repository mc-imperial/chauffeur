...
#ifndef USBDRIVERREWRITEVISITOR_H
#define USBDRIVERREWRITEVISITOR_H
...
namespace chauffeur
{
  using namespace clang;
	...
	class USBDriverRewriteVisitor : public AbstractDriverRewriteVisitor
	{
	protected:
	...
	public:
	  explicit USBDriverRewriteVisitor(CompilerInstance *CI, bool doInline)
      : AbstractDriverRewriteVisitor(CI, doInline)
    {

    }

    virtual ~USBDriverRewriteVisitor() {}
	};
}

#endif // USBDRIVERREWRITEVISITOR_H

...
namespace chauffeur
{
  ...
  bool TestDriverRewriteVisitor::VisitFunctionDecl(FunctionDecl* FD)
  {
  ...
  void TestDriverRewriteVisitor::InlineFunctions(FunctionDecl* FD, string fdFile)
  {
  ...
  void TestDriverRewriteVisitor::InstrumentEntryPoints(FunctionDecl* FD, string fdFile)
  {
    if (!(DI->getInstance().ExistsEntryPointWithName(FD->getNameInfo().getName().getAsString())))
      return;
  ...
  void TestDriverRewriteVisitor::InstrumentInitWithEntryPointCalls(FunctionDecl* FD, string fdFile)
  {
